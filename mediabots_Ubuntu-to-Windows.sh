...
link1_status=$(curl -Is https://ia802906.us.archive.org/22/items/windows_server_2019_x64_original_english_with_virtio/windows_server_2019_x64_original_english_with_virtio.iso | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://ia802906.us.archive.org/22/items/windows_server_2019_x64_original_english_with_virtio/windows_server_2019_x64_original_english_with_virtio.iso | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://archive.org/download/WS2012R2/WS2012R2.ISO # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://ia802906.us.archive.org/22/items/windows_server_2019_x64_original_english_with_virtio/windows_server_2019_x64_original_english_with_virtio.iso 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://ia802906.us.archive.org/22/items/windows_server_2019_x64_original_english_with_virtio/windows_server_2019_x64_original_english_with_virtio.iso
else
